...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">vishnudev</a></h1>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>vishnudev</h1>
      <p>I'm <span class="typed" data-typed-items=", Developer,electronic Technician,cycle and bike Technician"></span></p>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Iam vishnu ,silent boy,likes traval and music,shivabakthan</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <p class="fst-italic">
             target ariea in fultter-apps filed ,php-laraval-web filed
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>27-2-1996</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>9567949961</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>thikkodi,kozhikode,kerala,pin:673529</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                 
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Btech-ec</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>vishnudevrv96@gmail.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>relationship:</strong> <span>single</span></li>
                </ul>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">ui design-app,apk creating flutter framework <i class="val">50%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">PHP-laraval-web <i class="val">70%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">cycle $ bikes works<i class="val">60%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">repairing electronics device<i class="val">60%</i></span>
              <div class="progress-bar-wrap">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item">
              <h4>Btech &amp; EC</h4>
              <h5>2017 - 2020</h5>
              <p>ekc college of enginnering-malapuram<p>
            ...
            <div class="resume-item">
              <h4>Diploma &amp; EC</h4>
              <h5>2014 - 2017</h5>
              <p><em>Kmct polytechnic college-kozhikode</em></p>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              <h4>Gvhss boys koyilandi</h4>
              <h5>2012-2014</h5>
              <p><em>+2</em></p>
              
            </div>
            <div class="resume-item">
              <h4>Ckgmhss-chingapuram</h4>
              <h5>2012</h5>
              <p><em>SSLC</em></p>
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Frends</li>
              <li data-filter=".filter-card">myphotos</li>
              <li data-filter=".filter-web">college</li>
            </ul>
          </div>
        </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="fade-up">
                <p>
                  ...
                  Mayaanadhi (transl. Mystic river) is a 2017 Indian Malayalam-language romantic thriller film directed and co-produced by Aashiq Abu, and written by Syam Pushkaran and Dileesh Nair. The film stars Tovino Thomas as a criminal on the run and Aishwarya Lekshmi as an aspiring actress. Their troubled love and struggle for survival form the basic plot of the film. It released on 22 December 2017 to widespread critical acclaim from critics. The film was praised for the way it tackled with sexuality and was included in.
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>kerala,kozhikode,thikkodi</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>vishnudevrv96@gmail.com</p>
              </div>
